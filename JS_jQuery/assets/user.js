...
function constructGrid(data)
{
	...
	$.each(data['results'],function(key,value){
		  	...
		  	$("#collection").append("<div class='col s12 m6 l4 xl3'><a class='modal-trigger black-text ' href='#modal1' onclick='active_Carousel("+key+")'><div class='card-panel hoverable waves-effect waves-light'><div class='row'><div class='col s12'><img src='"+image_path+"' class='grid-image '><div></div><div class='col s12 name-card'><h6 class='center-align'>"+value['name']+"</h6></div></div></a></div>");});
...
function constructResultInfo(data)
{
	...
	let temp="<div class='center col' id='page-info-css'><div class='col'>Search for : <b>"+$("#keyword").val()+"</b></div>"+
				...
				"<div class='col'>Showing <b>"+data["results"].length+"</b> out of <b>"+data["total_results"]+"</b></div><div class='col'>Sort By : </div><div class='col'><a class='sort waves-effect waves-light' onclick='sort(\"popularity\")'> Popularity </a></div><div class='col'><a class='sort waves-effect waves-light' onclick='sort(\"name\")'> Name </a></div></div>";
