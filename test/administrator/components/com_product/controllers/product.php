 ...
 * @since  1.6
 */
class ProductControllerProduct extends JControllerAdmin
{
	/**
	...
	public function add()
	{
		...
		//die;
		$this->setRedirect(JRoute::_('index.php?option=com_product&view=product&layout=edit', false));
		//setRedirect('index.php?option=com_product&view=product&layout=edit');
	}
	public function cancel()
	{
		$this->setRedirect(JRoute::_('index.php?option=com_products', false));
	}
	/**
