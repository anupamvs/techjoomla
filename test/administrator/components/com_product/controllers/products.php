...
/**
 * Product master display controller.
 *
 * @since  1.0
 */
class ProductControllerProducts extends JControllerLegacy
{
	/**
	...
	public function display($cachable = false, $urlparams = false)
	{
		...
		// Check for edit form.
		if ($view == 'product' && $layout == 'edit' && !$this->checkEditId('com_users.edit.user', $id))
		{
